        ...
        <div class="row">
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    ?>
                     ...
                     <h2 class="page-header "> INVITADOS Y CATEGORIAS</h2>
                      <div class="row">
                      <div class="col-lg-3 col-xs-6">
                        <?php
                        ...
                        <!-- small box -->
                          <div class="small-box bg-gray">
                            <div class="inner">
                              <h3><?php echo $registrados['invitado']; ?></h3>
                            ...
                            <a href="lista-invitados.php" class="small-box-footer">
                              Más Información <i class="fa fa-arrow-circle-right"></i>
                            </a>
                          </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <!-- small box -->
                          <div class="small-box bg-blue">
                            <div class="inner">
                              <h3><?php echo $registrados['evento']; ?></h3>
                    ...
                    <div class="col-lg-3 col-xs-6">
                        <?php
                            $sql = "SELECT COUNT(id_admin) AS total_ad FROM admins ";
                            $resultado = $conn->query($sql);
                            $registrados = $resultado->fetch_assoc();
                        ?>
                        <!-- small box -->
                          <div class="small-box bg-blue">
                            <div class="inner">
                              <h3><?php echo $registrados['total_ad']; ?></h3>
